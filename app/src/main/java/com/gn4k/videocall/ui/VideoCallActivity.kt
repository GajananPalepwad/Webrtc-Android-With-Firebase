...
class VideoCallActivity : AppCompatActivity(), callHandler {
    ...
    override fun onStart() {
        super.onStart()
        requestScreenCapture = registerForActivityResult(
            ...
            if (it.resultCode == Activity.RESULT_OK) {
                ...
                service.startService(
                    email,
                    this,
                    mainServiceActions.FOREGROUND_SERVICE_TYPE_MEDIA_PROJECTION
                )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val database =
            FirebaseDatabase.getInstance("https://wallsplash-bce7e-default-rtdb.firebaseio.com/")
    ...
    private fun loadData() {
        ...
        firebaseWebRTCHandler = firebaseWebRTCHandler(
            this, userRef, email, userName, firebaseHandler
        );
        ...
        binding.videobtn.setOnClickListener {
            if (!videoHide) {
                ...
                binding.videobtn.setColorFilter(
                ...
                AlertDialog.Builder(this@VideoCallActivity)
                    ...
                    .setPositiveButton("Yes", object : DialogInterface.OnClickListener {
                        override fun onClick(p0: DialogInterface?, p1: Int) {
                            ...
                            binding.broadcastbtn.setBackgroundTintList(
                                getResources().getColorStateList(
                                    R.color.white
                                )
                            );
                            binding.broadcastbtn.setColorFilter(
